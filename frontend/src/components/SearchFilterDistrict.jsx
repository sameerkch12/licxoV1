                  ...
                  <div className="flex flex-col space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.bed === "1Bed" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        1 Bed
                      </button>
                      <button
                        onClick={() => handleFilterClick("bed", "2Bed")}
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.bed === "2Bed" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        2 Bed
                      </button>
                      <button
                        onClick={() => handleFilterClick("bed", "3Bed")}
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.bed === "3Bed" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        3 Bed
                      </button>
                    </div>
                    <div className="flex gap-2 ">
                      ...
                      <button
                        ...
                        className={`w-28 p-1 rounded-full text-blue-950 cursor-pointer ${filters.room === "Single Room" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        Single Room
                      </button>
                      <button
                        onClick={() => handleFilterClick("room", "1BHK")}
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.room === "1BHK" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        1BHK
                      </button>
                      <button
                        onClick={() => handleFilterClick("room", "2BHK")}
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.room === "2BHK" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        2BHK
                      </button>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`w-28 p-1 rounded-full text-blue-950 cursor-pointer ${filters.sort === "lowToHigh" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        Low to High
                      </button>
                      <button
                        onClick={() => handleFilterClick("sort", "highToLow")}
                        className={`w-28 p-1 rounded-full text-blue-950 cursor-pointer ${filters.sort === "highToLow" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        High to Low
                      </button>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.wifi === "Yes" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        Yes
                      </button>
                      <button
                        onClick={() => handleFilterClick("wifi", "No")}
                        className={`w-16 p-1 rounded-full text-blue-950 cursor-pointer ${filters.wifi === "No" ? "border border-blue-950 font-bold bg-blue-200" : "border"
                          }`}>
                        No
                      </button>
                    </div>
