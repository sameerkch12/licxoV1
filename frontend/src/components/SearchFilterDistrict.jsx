...
const SearchFilterDistrict = () => {
  ...
  return (
    <div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 border border-blue-200">
            ...
            <div className="flex justify-center ">
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-gray-800 to-gray-900 text-white font-bold rounded-lg hover:from-gray-900 hover:to-gray-800 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
      ...
      {/* Mobile View */}
      <div className="md:hidden bg-gradient-to-r from-gray-800 to-gray-900 p-4">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="bg-white rounded-xl shadow-xl p-4 border border-blue-200">
      ...
      <div className="flex gap-3 mb-4">
        ...
        {/* Search Button - 70% width with reduced height */}
        <button
          onClick={handleSearch}
          className="w-[70%] py-2 bg-gradient-to-r from-gray-800 to-gray-900 text-white font-bold rounded-lg transition-all shadow-md flex items-center justify-center hover:opacity-90"
        >
